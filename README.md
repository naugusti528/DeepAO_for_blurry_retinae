...
## Model Architecture
U-Net – encoder → bottleneck → decoder → skip connections<br>
Loss functions: Anatomical Priority Loss --> combines anatomical feature extraction with a localized 2D Laplacian convolution filter<br>
Evaluation metrics: SSIM, PSNR<br>
Post-processing: Applied localized Contrast-Limited Adaptive Histogram Equalization (CLAHE) to enhance local contrast and improve the visibility of retinal blood vessels<br>
...
Optimizer: Adam<br>
Learning rate: 1e-4 (0.0001)<br>
Framework: PyTorch<br>
Hardware: Apple Silicon GPU (MPS Acceleration)<br>
...
## Data Specifications
The Kaggle dataset used for this project is 22 GB and is excluded via the .gitignore to maintain a lightweight and fast codebase.<br>
